    ...
    <section class="space-top space-extra-bottom">
        <div class="container">
            <div class="row gy-30 mb-30">
                <div class="col-xl-4 col-sm-6">
                    <div class="blog-style1">
                        ...
                        <h3 class="box-title-24"><a class="hover-line" href="blog-details.php">Kejuaraan Rally Dunia: Meriahkan Kecepatan dan Ketangguhan di Jalan Tanah yang Menantang</a></h3>
                        <div class="blog-meta">
            ...
            <div class="th-pagination mt-40 text-center">
                <ul>
                    <li><a href="blog-three-column.php">01</a></li>
                    <li><a href="blog-three-column.php"><i class="fas fa-arrow-right"></i></a></li>
                </ul>
            </div>
        </div>
    </section>
