...
<head>
    ...
    <title>Tnews - News & Magazine HTML Template - Blog Details Video</title>
...
============================== -->
    ...
    <section class="th-blog-wrapper blog-details bg-smoke space-top space-extra-bottom">
        <div class="container">
                    ...
                    <div class="th-blog blog-single style-bg">
                        ...
                        <div class="blog-video">
                            <div class="vimeo-video">
                                <iframe src="https://player.vimeo.com/video/71544334?h=0351668569&title=0&byline=0&portrait=0" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="blog-content-wrap">
                            ...
                            <div class="blog-content">
                                ...
                                <div class="content">
                                    ...
                                    <div class="my-4 py-lg-2">
                                        <div class="th-video" data-overlay="black" data-opacity="5">
                                            <img class="w-100" src="assets/img/blog/blog_inner_8.jpg" alt="Blog Image">
                                    ...
                                    <blockquote>
                                        <p>Fuel your competitive spirit, chase victory, and let sports be your legacy Encapsulates the essence.</p>
                                        <cite>Robert Milton</cite>
                                    </blockquote>
                                    <div class="row mb-4 pb-lg-2 pt-xl-2 gy-4">
                                        <div class="col-md-6">
                                            <div class="th-video" data-overlay="black" data-opacity="6">
                                                <img class="w-100" src="assets/img/blog/blog_inner_9.jpg" alt="Blog Image">
                                                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn style2 popup-video"><i class="fas fa-play"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="th-video" data-overlay="black" data-opacity="6">
                                                <img class="w-100" src="assets/img/blog/blog_inner_10.jpg" alt="Blog Image">
                                                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn style2 popup-video"><i class="fas fa-play"></i></a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="related-post-wrapper pt-15 mb-30">
                ...
                <div class="row slider-shadow th-carousel" id="related-post-slide" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2">
