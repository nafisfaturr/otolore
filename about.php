            ...
            <div class="widget  ">
                ...
                <div class="recent-post-wrap">
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details-nosidebar.php"><img src="assets/img/blog/recent-post-1-1.jpg" alt="Blog Image"></a>
                        </div>
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details-nosidebar.php"><img src="assets/img/blog/recent-post-1-2.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details-nosidebar.php"><img src="assets/img/blog/recent-post-1-3.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details-nosidebar.php"><img src="assets/img/blog/recent-post-1-4.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-7 mb-30 mb-xl-0">
                    <div class="img-box1">
                        <div class="img1">
                            <img src="assets/img/michael-fousert-1XgbEO7siqg-unsplash.jpg" alt="About">
                        </div>
                        <div class="img2">
                            <img src="assets/img/rob-csaszar-b5yiBMHk5sQ-unsplash.jpg" alt="Image">
                        </div>
                ...
                <div class="col-xl-5">
                    <div class="title-area mb-32">
                        ...
                        <h2 class="sec-title2">Lebih dari 5 tahun, Kami telah memberikan berita terpercaya, terbaru dan tebaik</h2>
                        <p class="sec-text" style="text-align: justify;">Di Otolore , kami memahami betapa pentingnya dunia otomotif dalam kehidupan sehari-hari. Itulah mengapa kami menempatkan keandalan dan keberagaman informasi sebagai prioritas utama. Tim redaksi kami terdiri dari para profesional yang berpengalaman dan bersemangat dalam menyajikan konten berkualitas tinggi kepada Anda.

                            Dari peluncuran mobil dan motor terbaru hingga perkembangan teknologi otomotif terkini, kami berjanji untuk tetap menghadirkan liputan yang mendalam dan informatif. Kami percaya bahwa informasi yang tepat adalah kunci untuk membuat keputusan yang baik, dan itulah yang ingin kami sampaikan kepada pembaca kami.
                            
                            Kami juga sangat menghargai keterlibatan dan umpan balik dari pembaca kami. Jika Anda memiliki pertanyaan, saran, atau cerita yang ingin Anda bagikan, jangan ragu untuk menghubungi kami. Kami selalu siap mendengar dan menjawab setiap pertanyaan atau masukan yang Anda miliki.</p>
                    </div>
                    <div class="checklist mt-n2 mb-35">
                        <ul>
                            <li><i class="far fa-check-circle"></i> Terpercaya</li>
                            <li><i class="far fa-check-circle"></i> Terbaru</li>
                            <li><i class="far fa-check-circle"></i> Terbaik</li>
                        </ul>
                    </div>
                    <a href="about.php" class="th-btn">About More<i class="fas fa-arrow-up-right ms-2"></i></a>
                </div>
            </div>
        </div>
    </div>
...
Cta Area  
==============================-->
    <section class="cta-sec-1" data-bg-src="assets/img/gambar/grahame-jenkins-p7tai9P7H-s-unsplash.jpg">
            ...
            <div class="row text-center text-md-start align-items-center justify-content-md-between justify-content-center">
                <div class="col-lg-7 col-md-8 mb-40 mb-md-0">
                    <div class="title-area mb-0">
                        <span class="sub-title">DAPATKAN KONSULTASI</span>
                        <h2 class="sec-title2 h1 text-white">Rasakan keunggulan majalah kami</h2>
                    </div>
                </div>
                <div class="col-md-auto">
                    <a href="contact.php" class="th-btn style3">Contact Us<i class="fas fa-arrow-up-right ms-2"></i></a>
                </div>
            </div>
        </div>
    </section><!--==============================
        ...
        <div class="container">
            <div class="counter-card-wrap">
                <div class="counter-card">
                    ...
                    <span class="counter-card_text">Tahun Berpengalaman</span>
                </div>
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number">86</span>+</h2>
                    <span class="counter-card_text">Mitra Terpercaya</span>
                </div>
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number">149</span>+</h2>
                    <span class="counter-card_text">Penulis Berpengalaman</span>
                </div>
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number">15</span>+</h2>
                    <span class="counter-card_text">Penerjemah bahasa</span>
                </div>
            </div>
        </div>
    </div><!--==============================
        ...
        <div class="container">
            ...
            <div class="story-box-area" data-bg-src="assets/img/normal/story_bg_1.svg">
                <div class="story-box-wrap">
                    <div class="story-box">
                        <div class="box-img">
                            <img src="assets/img/gambar/anthony-delanoix-hzgs56Ze49s-unsplash.jpg" alt="Image">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title">Pendirian</h3>
                            <p class="box-text"> Pendirian Otolore sebagai sebuah blog kecil yang didedikasikan untuk menyajikan berita otomotif kepada para pecinta otomotif. </p>
                        </div>
                    </div>
                ...
                <div class="story-box-wrap">
                    <div class="story-box">
                        <div class="box-img">
                            <img src="assets/img/gambar/auto-2179220_1920.jpg" alt="Image">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title">Perkembangan awal</h3>
                            <p class="box-text"> Otolore mulai menambahkan kolom ulasan kendaraan dan artikel tentang teknologi otomotif terbaru untuk memberikan konten yang lebih bervariasi kepada pembaca.</p>
                        </div>
                    </div>
                ...
                <div class="story-box-wrap">
                    <div class="story-box">
                        <div class="box-img">
                            <img src="assets/img/gambar/dhiva-krishna-X16zXcbxU4U-unsplash.jpg" alt="Image">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title">Perkembangan</h3>
                            <p class="box-text"> Situs web Otolore diperluas dengan penambahan kategori baru seperti tips & trik, lifestyle otomotif, dan liputan acara dan komunitas otomotif untuk memenuhi kebutuhan pembaca yang semakin bertambah. </p>
                        </div>
                    </div>
                ...
                <div class="story-box-wrap">
                    <div class="story-box">
                        <div class="box-img">
                            <img src="assets/img/gambar/nicholas-green-nPz8akkUmDI-unsplash.jpg" alt="Image">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title">Perkembangan</h3>
                            <p class="box-text"> Otolore terus berkembang dan menjadi salah satu otoritas utama dalam industri otomotif, dengan misi untuk terus menyediakan informasi terkini, akurat, dan bermanfaat kepada para pecinta otomotif di seluruh dunia. </p>
                        </div>
                    </div>
