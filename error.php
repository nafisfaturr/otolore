...
<head>
    ...
    <title>Tnews - News & Magazine HTML Template - 404 - Error Page</title>
...
==============================-->
    <section class="space2">
        <div class="container">
            <div class="error-img">
                <img class="light-img" src="assets/img/theme-img/error.svg" alt="404 image">
                <img class="dark-img" src="assets/img/theme-img/error-dark.svg" alt="404 image">
            </div>
            <div class="error-content">
                ...
                <a href="home-newspaper.html" class="th-btn"><i class="fal fa-home me-2"></i>Back To Home</a>
            </div>
        </div>
    </section><!--==============================
	Footer Area
