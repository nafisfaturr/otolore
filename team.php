...
<head>
    ...
    <title>Tnews - News & Magazine HTML Template - Our Team</title>
    <meta name="author" content="Tnews">
    <meta name="description" content="Tnews - News & Magazine HTML Template">
    <meta name="keywords" content="Tne  ws - News & Magazine HTML Template">
        ...
        <div class="container">
            <div class="row gy-30">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="team-card">
                        <div class="box-img">
                            <img src="assets/img/avatar/alex-suprun-ZHvM3XIOHoE-unsplash.jpg" alt="Team">
                            <div class="th-social">
                        ...
                        <h3 class="box-title"><a href="#">MUHAMMAD ADZKA</a></h3>
                        <p class="box-text">News Director</p>
                    </div>
                </div>
                <!-- Single Item -->
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="team-card">
                        ...
                        <h3 class="box-title"><a href="#">NAFIS FATURRAHMAN</a></h3>
                        <p class="box-text">Sr. Writer</p>
                    </div>
                </div>
                <!-- Single Item -->
                <div class="col-sm-6 col-lg-4 col-xl-3">
