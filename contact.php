            ...
            <div class="row">
                <div class="col-xl-5">
                    <div class="pe-xxl-4 me-xl-3 text-center text-xl-start mb-40 mb-lg-0">
                        <div class="title-area mb-32">
                            <h2 class="sec-title2">Hubungi Kami</h2>
                            <p class="sec-text">Kontak kami bila ada masukkan dan kritik di :</p>
                        </div>
                        <div class="contact-feature-wrap">
                            <div class="contact-feature">
                                ...
                                <div class="box-content">
                                    <h3 class="box-title-22">Alamat Kami</h3>
                                    <p class="box-text">Jalan bogor kecamatan cibinong kota bogor jawa barat</p>
                                </div>
                            </div>
                            <div class="contact-feature">
                                <div class="box-icon">
                                ...
                                <div class="box-content">
                                    <h3 class="box-title-22">Alamat Email</h3>
                                    <p class="box-text">
                                        <a href="mailto:needhelp@gmail.com">Otolore@gmail.com</a>
                                        <a href="mailto:info@gmail.com">Otolore@gmail.com</a>
                                    </p>
                                </div>
                            </div>
                            <div class="contact-feature">
                ...
                <div class="col-xl-7">
                    <div class="quote-form-box">
                        ...
                        <form action="mail.html" method="POST" class="contact-form ajax-contact">
                            <div class="row">
...
Contact Area  allowfullscreen="" loading="lazy"
==============================-->
    <div class="contact-map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15853.825447484958!2d106.8061404!3d-6.5900593!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c57f789ece17%3A0xf03dc8909a252540!2sSV%20IPB!5e0!3m2!1sid!2sid!4v1710267449998!5m2!1sid!2sid" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div><!--==============================
	Footer Area
==============================-->
