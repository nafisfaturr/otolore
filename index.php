                        ...
                        <div class="col-xl-6 col-md-6 dark-theme img-overlay2">
                            <div class="blog-style3">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="box-title-18"><a class="hover-line" href=" ">Mengulas Performa Mobil Sport Terbaru: Tes Lapangan di Sirkuit Terkenal</a></h3>
                                    <div class="blog-meta">
                                        <!-- <a href="team.php"><i class="far fa-user"></i>By - Cahya</a> -->
            ...
            <div class="row th-carousel" id="blog-slide4" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2">
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="blog-style1">
                        ...
                        <h3 class="box-title-22"><a class="hover-line" href=" ">Mengulas Teknologi Self-Driving Terbaru: Fitur Autopilot Tesla Model X 2024 dan Fitur-Fitur Terkemuka Lainnya</a></h3>
                        <div class="blog-meta">
                            <!-- <a href="team.php"><i class="far fa-user"></i>By - Cahya</a> -->
                            <a href="blog.php"><i class="fal fa-calendar-days"></i>13 Mar, 2024</a>
                        </div>
